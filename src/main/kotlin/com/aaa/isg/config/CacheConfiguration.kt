...
class CacheConfiguration(jHipsterProperties: JHipsterProperties) {
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.aaa.isg.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.aaa.isg.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.aaa.isg.domain.User::class.java.name)
            createCache(cm, com.aaa.isg.domain.Authority::class.java.name)
            createCache(cm, com.aaa.isg.domain.User::class.java.name + ".authorities")
